...
image:../media/beegfs-components.png["BeeGFS Components"]
...
image:../media/beegfs-design-image1.png[HA architecture comparison]
...
image:../media/beegfs-design-image2-small.png[Building block]
...
image:../media/beegfs-design-image3.png[BeeGFS HA cluster scaling]
