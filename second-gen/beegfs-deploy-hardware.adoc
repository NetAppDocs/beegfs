...
+
. Connect the file and block nodes using thelink:beegfs-technology-requirements.html#file-node-cables[file node InfiniBand cables] to match the topology shown in the figure below.
+
[NOTE]
