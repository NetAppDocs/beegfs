...
image:../media/beegfs-design-image5-small.png[NUMA configuration]
...
image:../media/beegfs-design-image6.png[Network cabling]
...
image:../media/beegfs-design-image7.png[HCA bidirectional bandwidth]

For each BeeGFS service, use the same adapter to connect the preferred port used for client traffic with the path to the block nodes controller that is the primary owner of that services volumes. For more information, see link:second-gen/beegfs-design-software-architecture.html[Software configuration].
