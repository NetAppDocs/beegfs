...
image:../media/high-capacity-rack-diagram.png["High capacity rack diagram"]
...
image:../media/high-capacity-drive-slots-diagram.png["High capacity drive slot diagram"]
