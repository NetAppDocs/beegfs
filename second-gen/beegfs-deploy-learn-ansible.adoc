...
[NOTE]
  Although the deployment steps attempt to provide enough detail that prior experience with Ansible is not a prerequisite, some familiarity with Ansible and related terminology is strongly recommended.
