...
image:../media/beegfs-design-image13.png[Single BeeGFS base building block IOR results]
...
image:../media/beegfs-design-image14.png[Single BeeGFS metadata and storage building blocks IOR results]
...
image:../media/beegfs-design-image15.png[]Single BeeGFS storage IOR results

.Three BeeGFS building blocks
The following figure shows the IOR test results with three BeeGFS building blocks.

image:../media/beegfs-design-image16.png[Three BeeGFS building blocks IOR results]
...
image:../media/beegfs-design-image17.png[Three BeeGFS building blocks with single client IOR results]
...
image:../media/beegfs-design-image18.png[Single BeeGFS metadata and storage building blocks MDTest results]
...
image:../media/beegfs-design-image19.png[Two BeeGFS metadata and storage building blocks MDTest results]
