...
* link:second-gen/beegfs-design-hardware-architecture.html[Hardware configuration]
* link:second-gen/beegfs-design-software-architecture.html[Software configuration]
* link:second-gen/beegfs-design-solution-verification.html[Design verification]
* link:second-gen/beegfs-design-solution-sizing-guidelines.html[Sizing guidelines]
* link:second-gen/beegfs-design-performance-tuning.html[Performance tuning]
