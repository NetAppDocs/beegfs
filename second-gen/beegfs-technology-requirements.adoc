...
a|Each file node should meet or exceed the specifications of the listed verified file nodes to achieve expected performance.

*Verified file node options:*
...
*Connections directly from the block nodes to the file nodes.*
...
| 8
| MCP1650-H001E30 (Nvidia Passive Copper cable, QSFP56, 200Gbps)
| 1m
|===

*Connections from file nodes to the storage network switch.*
Select one option from the table below according to your InfiniBand storage switch. +
Lengths will vary according to customer environment.
