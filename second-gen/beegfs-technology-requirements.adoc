...
[block-file-cables]*Connections directly from the block nodes to the file nodes.*
...
The recommended cable length is 2m, but may vary according to customer environment.
