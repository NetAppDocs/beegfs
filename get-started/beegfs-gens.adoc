...
[.lead]
The BeeGFS on NetApp solution offers a first and second generation architecture.

Each generation incorporates a BeeGFS file system and an NVMe EF600 storage system. The second generation builds on the first to include these additional benefits:
