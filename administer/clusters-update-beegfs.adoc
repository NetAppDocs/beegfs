...
| 7.4.6            | 8.0             | Yes       | Upgrade using the instructions in the link:clusters-update-beegfs-v8.html[Upgrade to BeeGFS v8] procedure.
| 7.4.6            | 8.1             | Yes       | Upgrade using the instructions in the link:clusters-update-beegfs-v8.html[Upgrade to BeeGFS v8] procedure.
| 7.4.6            | 8.2             | Yes       | Upgrade using the instructions in the link:clusters-update-beegfs-v8.html[Upgrade to BeeGFS v8] procedure.
|===
