...
beegfs_ha_fencing_agents:
  fence_redfish:
    ...
    - pcmk_host_list: <HOSTNAME>
      ...
      <<: *redfish
----
... For details on configuring other fencing agents refer to the link:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/9/html/configuring_and_managing_high_availability_clusters/assembly_configuring-fencing-configuring-and-managing-high-availability-clusters[Red Hat Documentation^].
...
Click link:https://github.com/NetApp/beegfs/blob/master/getting_started/beegfs_on_netapp/gen2/H2_DAC_IB_A2_EF600/beegfs_cluster_building_blocks/beegfs_ha_building_block_cluster_1/group_vars/ha_cluster.yml[here^] for an example of a complete inventory file representing common file node configuration.
