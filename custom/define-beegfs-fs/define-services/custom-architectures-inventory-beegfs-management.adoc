...
Create a new file `group_vars/mgmt.yml` and referencing the link:custom-architectures-plan-file-system.html[Plan the File System^] section populate it as follows:
