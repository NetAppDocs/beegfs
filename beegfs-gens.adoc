...
[.lead]
The BeeGFS on NetApp architecture offers a first and second generational design.

Each generation includes a BeeGFS file system and an NetApp NVMe EF600 storage system. The second generation builds on the first to include these additional benefits:
